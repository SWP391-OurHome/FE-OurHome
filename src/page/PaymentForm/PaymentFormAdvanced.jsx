...
const PaymentFormAdvanced = () => {
    const [name, setName] = useState('');
    const [email, setEmail] = useState('');
    const amount = 50;
    const [paymentUrl, setPaymentUrl] = useState('');
    const membershipType = 'ADVANCED';
    ...
    return (
        <div className="payment-form-container">
            <div className="payment-form card shadow-sm p-4">
                <h2 className="text-center mb-4 text-primary">Payment for Advanced Plan</h2>
                <div className="row g-3">
                    ...
                    <div className="col-12">
                        <div className="form-group">
                            ...
                            <small className="text-muted">Amount is fixed for Advanced plan</small>
                        </div>
                    </div>
                </div>
...
export default PaymentFormAdvanced;
