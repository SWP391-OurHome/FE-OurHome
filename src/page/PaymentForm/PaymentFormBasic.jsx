    ...
    return (
        <div className="payment-form-container">
            <div className="payment-form card shadow-sm p-4">
                <h2 className="text-center mb-4 text-primary">Payment for Basic Plan</h2>
                <div className="row g-3">
                    ...
                    <div className="col-12">
                        <div className="form-group">
                            ...
                            <small className="text-muted">Amount is fixed for Basic plan</small>
                        </div>
                    </div>
                </div>
...
export default PaymentFormBasic;