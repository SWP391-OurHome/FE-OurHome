    ...
    return (
        <div className="payment-form-container">
            <div className="payment-form card shadow-sm p-4">
                <h2 className="text-center mb-4 text-primary">Payment Form</h2>
                <div className="row g-3">
                    ...
                    <div className="col-12">
                        <div className="form-group">
                            ...
                            <p className="text-info fw-bold mb-0">50 VND (*100 = 5000 VND)</p>
                            <small className="text-muted">Amount is fixed</small>
                        </div>
                    </div>
                </div>
                <div className="text-center mt-4">
                    <PayOSIntegration name={name} email={email} amount={amount} onSuccess={handlePaymentSuccess} />
                </div>
                <div className="text-center mt-3">
                    <div className="row">
                        ...
                        <div className="col-12">
                            <p className="text-muted">
                                Amount: <span className="text-info fw-bold">{amount} VND (*100 = {amount * 100} VND)</span>
                            </p>
                        </div>
                    </div>
                </div>
